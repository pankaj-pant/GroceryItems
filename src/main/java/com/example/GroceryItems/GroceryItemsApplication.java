...
public class GroceryItemsApplication {
	...
	public CommandLineRunner demo(ItemRepository repository, ShopRepository srepository, UserRepository urepository) {
		...
		User user1 = new User("child", "$2a$10$03T10f0cXJ6JMl9ftE6LT.Hs7Q/BGHvl56T6T5kCWiI6Bspi6hDOC", "child@shoppinglist.com", "CHILD");
		User user2 = new User("parent", "$2a$10$VKvPbrB0ZwSEyBP1G7/nNu7HwA2fw0DnzmTzr8jShrTUcM6ZX/r3.", "parent@shoppinglist.com", "PARENT");
